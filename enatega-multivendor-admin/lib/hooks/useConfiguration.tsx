...
import { BACKEND_URL } from '@/lib/utils/constants/url';
...
export const useConfiguration = () => {
  ...
  return {
    SERVER_URL: process.env.NEXT_PUBLIC_SERVER_URL || urls.SERVER_URL,
    WS_SERVER_URL: process.env.NEXT_PUBLIC_WS_SERVER_URL || urls.WS_SERVER_URL,
    COLORS,
