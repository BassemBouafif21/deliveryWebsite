...
### Local Backend (Open Replacement)

This repository now includes a self-hosted backend replacement in:
...
- HTTP GraphQL: `http://localhost:8001/graphql`
- WS GraphQL: `ws://localhost:8001/graphql`
